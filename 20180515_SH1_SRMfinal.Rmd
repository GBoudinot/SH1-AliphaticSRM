...
## Normalize to TOC data from Jones et al., (2018) (intrpolation required)
...
### Stratification
```{r "", fig.width = 20, fig.height = 5}
HHIGI <- subset(alldata_w_time, var %in% c("d13c_org", "HHI", "Chlorobactane", "Isorenieretane", "C31_35_3MHI(%)")) %>%
  ggplot() +
  aes(x = ka, y = value, color = var) +
  geom_point() +
  #geom_line() +
