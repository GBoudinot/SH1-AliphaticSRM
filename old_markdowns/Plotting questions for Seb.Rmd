---
title: "Plotting questions for Seb :)"
output: 
  html_document:
    df: paged
    toc: true
...
opts_chunk$set(
  ...
  fig.keep="all", fig.path = file.path("plots", "smoky_hollows_SRM")) 
```
...
- Brochs et al. 2017 [main figure] (https://www.nature.com/articles/nature23457/figures/1)
- Stacked multi-biomarker [plots] (https://gsw.silverchair-cdn.com/gsw/Content_public/Journal/geology/43/4/10.1130_G36371.1/4/307fig2.jpeg?Expires=1523130878&Signature=emOjV94RJtkBAUdERves7OzRAyGk4ZLv7GmXVfvl~tcQTG1k4ekQNrs3aymLYVSOSVjUezo0~GdI1TzdolcaS5zg52jkC1BI6WF7iqLdlsocpiOA-7E5Jsf58MdCwJLTTEDoBLhg3i7V3X600sOHi1UbEyZWUlmU~qK5HYKO7UGDk1x63bZdJyn~g-2nYf4PoWwwI~V5ugjXrU6zbEEJbhvwnGepyJeOOuq7sFpiuu9eLisxi~EfFfvPF2cGiEeZLMTp-BPUKEDosmd5F53VXVU7U2ZhHnClOkPTZzgvvSrbbRctX8Gx~irjhnFdY~aK7VCFDnXN9Zxd9XN7uFxU7A__&Key-Pair-Id=APKAIUCZBIA4LVPAVW3Q) w/ strat column 
