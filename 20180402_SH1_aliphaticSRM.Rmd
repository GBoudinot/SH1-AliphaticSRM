---
title: "20180402_SH1_aliphaticSRM"
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C19 Tri HO") %>%
  ggplot() +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C20 Tri HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C21 Tri HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C22 Tri HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C23 Tri HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C24 Tet HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C24 Tri HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C25 Tri R HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C25 Tri S HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 21-nor") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 aaa 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 aaa 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 aBB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 aBB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 Ba 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 Ba 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 Tri R HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C26 Tri S HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 17B H Ho") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 aaa 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 aaa 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 aB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 aB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 aBB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 aBB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 Ba 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C27 Ba 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 aaa 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 aaa 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 aB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 aB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 aBB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 aBB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 Ba 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C28 Ba 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aaa 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aaa 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aB HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aBB 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 aBB 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 Ba 20R ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 Ba 20S ST") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
...
```{r "", fig.width = 10, fig.height = 8}
subset(final_data, peak_name== "C29 Ba HO") %>%
  ggplot() +
  aes(x = conc_rock.ug_g, y = depth) +
  geom_point() +
  facet_wrap(~peak_name, scales = "free") +
