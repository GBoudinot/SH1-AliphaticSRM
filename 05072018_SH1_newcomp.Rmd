...
```{r}
export <- final_data %>% select("file_id", "peak_name", "area.cpm", "depth", "OG", "amount.ug", "conc_rock.ug_g", "conc_tle.ug.g", "conc_maltene.ug.g", "yield", "ratio")

write.csv(export, file = "aliphatic.csv")
```
